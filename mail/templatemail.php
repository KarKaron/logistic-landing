...
<body paddingwidth="0" paddingheight="0" style="background-color: #333333;padding-top: 0; padding-bottom: 0; padding-top: 0; padding-bottom: 0; background-repeat: repeat; width: 100% !important; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;" offset="0" toppadding="0" leftpadding="0" class="bgBody">
      ...
      <tbody>
        <tr>
          <td>
            <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="MainContainer" style="font-family: 'Roboto Condensed', sans-serif;">
              <tbody>
                <tr>
                  <td>
...
<!--  =========================== The body ===========================  -->
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >
                                <tr>
                                  <td bgcolor="#698EC3" style="padding:20px;border-bottom-left-radius:3px;border-bottom-right-radius:3px;" align="center">
                                    <div class="contentEditableContainer contentTextEditable" style="display:inline-block;">
                                      <div class="contentEditable" >
                                        <p style="color:#ffffff;font-size:16px;line-height:19px;"><?=$siteNAME?></p>
                                      </div>
                                    </div>
                                  </td>
                                </tr>
                            ...
                            <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >
                                ...
                                <tr>
                                  <td style="border-bottom:1px solid #454649"></td>
                                </tr>
                                <tr>
                                  <td height="15">&nbsp;</td>
                                </tr>
                            ...
                            <div class="movableContent" style="border: 0px; padding-top: 0px; text-align:center;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tbody>
                                  <tr>
                                    <td valign="top">
                                        <a href="<?=$siteURL?>" title="Перейти на сайт" target="_blank" style="display:block;padding:15px 20px;background:#698EC3;border:0;border-radius:3px;margin:10px auto 30px auto;color:#ffffff;text-decoration:none;width:200px;">Перейти на сайт</a>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
